...
class Planet:
    AU = 149.6e6 * 1000  # Unidade Astronômica em metros
    G = 6.67428e-11  # Constante Gravitacional
    SCALE = 200 / AU  # 1 AU = 100 pixels
    TIMESTEP = 3600 * 24  # 1 dia em segundos
...
# sol
    sun = Planet(0, 0, 30, YELLOW, 1.98892 * 10**30)  # Massa astronômica correta
    sun.sun = True  # Não precisa de órbita
# terra
    earth = Planet(-1 * Planet.AU, 0, 16, BLUE, 5.9742 * 10**24)
    earth.y_vel = 29783  # m/s
# marte
    mars = Planet(-1.524 * Planet.AU, 0, 12, RED, 6.39 * 10**23)
    mars.y_vel = 24007  # m/s
# mercurio
